...
import br.com.cupuama.controller.mapper.products.ProductMapper;
...
import br.com.cupuama.service.products.ProductFruitService;
...
public class ProductFruitController {
	...
	public ProductFruitDTO createProductFruit(@Valid @RequestBody final ProductFruitDTO productFruitDTO) throws ConstraintsViolationException {
		...
		return ProductFruitMapper.makeProductFruitDTO(productFruitService.create(productFruit));
	}
	...
	@GetMapping("/products/{fruitId}")
	public List<ProductDTO> findProductsByFruitId(@PathVariable final long fruitId) {
		return ProductMapper.makeProductDTOList(productFruitService.findProductsByFruitId(fruitId));
	}
	
	@GetMapping("/fruits/{fruitId}")
	public List<FruitDTO> findFruitsByProductId(@PathVariable final long productId) {
		return FruitMapper.makeFruitDTOList(productFruitService.findFruitsByProductId(productId));
	}
